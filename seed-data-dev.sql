-- ============================================================
-- GOR Management System - Seed Data (DEVELOPMENT MODE)
-- Passwords stored as PLAIN TEXT for testing only
...
-- PLAIN TEXT PASSWORDS (DEVELOPMENT MODE ONLY)
-- ============================================================
-- Credentials:
-- admin@gor.id / admin123
-- kasir@gor.id / kasir123
-- finance@gor.id / finance123
-- supplier@sportstuff.id / supplier123
-- andi@sport.id / reseller123
-- rudi@gmail.com / rudi123
-- dian@gmail.com / dian123

INSERT INTO users (role_id, name, email, password_hash, phone, address, is_active) VALUES
-- Admin (role_id = 1)
(1, 'Admin GOR', 'admin@gor.id', 'admin123', '081234567890', 'Bandung', 1),
-- Kasir (role_id = 2)
(2, 'Budi Kasir', 'kasir@gor.id', 'kasir123', '081234567891', 'Bandung', 1),
-- Finance (role_id = 3)
(3, 'Sari Finance', 'finance@gor.id', 'finance123', '081234567892', 'Bandung', 1),
-- Supplier (role_id = 4)
(4, 'PT Sportstuff', 'supplier@sportstuff.id', 'supplier123', '021-5551234', 'Jakarta', 1),
-- Reseller (role_id = 5)
(5, 'Toko Andi Sport', 'andi@sport.id', 'reseller123', '081298765432', 'Bandung', 1),
-- Pelanggan (role_id = 6)
(6, 'Rudi Santoso', 'rudi@gmail.com', 'rudi123', '08129876543', 'Bandung', 1),
(6, 'Dian Pratiwi', 'dian@gmail.com', 'dian123', '08129876544', 'Bandung', 1);
...
-- Summary
-- ============================================================
-- DEVELOPMENT MODE: All passwords are stored as plain text
-- 
-- Demo Accounts:
-- 1. admin@gor.id / admin123
-- 2. kasir@gor.id / kasir123
-- 3. finance@gor.id / finance123
-- 4. supplier@sportstuff.id / supplier123
-- 5. andi@sport.id / reseller123
-- 6. rudi@gmail.com / rudi123
-- 7. dian@gmail.com / dian123
--
-- Total: 7 Users, 4 Contracts, 3 Orders, 3 Transactions, 10 Stock Items
-- ============================================================
